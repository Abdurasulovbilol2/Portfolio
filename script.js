    ...
    if (entry.isIntersecting) {
      if (entry.target.classList.contains("skill-category")) {
        ...
        const skillCategories =
          entry.target.parentElement.querySelectorAll(".skill-category");
...
document.addEventListener("DOMContentLoaded", () => {
  const elements = document.querySelectorAll(
    ".project-card, .skill-category, .artifact-card, .about-text, .about-stats",
  );
  elements.forEach((el) => {
...
if (contactForm) {
  contactForm.addEventListener("submit", function (e) {
    ...
    if (!isEmailJSConfigured()) {
      ...
      showFormStatus(
        "📧 Opening your email client... If this doesn't work, please email me directly at abdurasulovbiloliddin98@gmail.com",
        "info",
      );
      contactForm.reset();
      return;
    ...
    emailjs
      ...
      .catch(function (error) {
        ...
        showFormStatus(
          "📧 Opening your email client as a backup... You can also email me directly.",
          "info",
        );
        setTimeout(() => {
          window.location.href = mailtoUrl;
